...
class SyllabusesControllerTest < ActionController::TestCase
  ...
  test "should create syllabus" do
    assert_difference('Syllabus.count') do
      post :create, syllabus: { description: @syllabus.description, duration: @syllabus.duration, name: @syllabus.name }
    end
  ...
  test "should update syllabus" do
    patch :update, id: @syllabus, syllabus: { description: @syllabus.description, duration: @syllabus.duration, name: @syllabus.name }
    assert_redirected_to syllabus_path(assigns(:syllabus))
  end
